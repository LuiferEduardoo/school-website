...
import { RiDashboardLine, RiArrowRightSLine, RiArrowUpSLine   } from 'react-icons/ri';
    ...
    <>
      <li>
        <Link
          ...
          className={`flex items-center gap-3 p-4 ${
            isActive("") && "bg-gray-200 rounded-lg transition-colors"
          }`}
        >
          <RiDashboardLine />
          Dashboard
      ...
      <li>
        <div
          ...
          onClick={() =>
            setShowOptionsContentManagement(!isShowOptionsContentManagement)
          }
        >
          <BiBookContent />
        ...
        >
          <ShowOptions
            isShow={isShowOptionsContentManagement}
            isActive={isActive}
          />
        </CSSTransition>
      </li>
