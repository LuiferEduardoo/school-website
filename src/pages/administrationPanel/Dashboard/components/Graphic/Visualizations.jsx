...
import { Card, Text, Metric, LineChart, Title, BarChart, BarList, Bold, Flex  } from "@tremor/react";
  ...
  const chartdata2 = [
    {
        ...
        "Home": 890,
        "Admisiones": 338,
        "Proyectos institucionales": 538
    },
    {
        date: "2",
        "Home": 289,
        "Admisiones": 233,
        "Proyectos institucionales": 253
    },
    {
        date: "3",
        "Home": 380,
        "Admisiones": 535,
        "Proyectos institucionales": 352
    },
    {
        date: "4",
        "Home": 90,
        "Admisiones": 98,
        "Proyectos institucionales": 28
    },
  ];
const chartdata4 = [
    {
    ...
    return (
        <>
            <div className='flex flex-col gap-4 lg:grid grid-cols-3'>
                <Card className="max-w-xs max-h-30 mx-auto lg: col-span-1">
                    <Text>Visitas</Text>
                    <Metric>347</Metric>
                </Card>
                ...
                <Card className="max-w-lg lg: col-span-1">
                ...
                <Card className="lg: col-span-4">
                    <Title>Visitas en cada sección de la pagina</Title>
                    <BarChart
                        className="mt-6"
                        data={chartdata2}
                        index="date"
                        categories={["Home", "Admisiones", "Proyectos institucionales"]}
